...
To open DevTools you can either right click in the browser and click 'Inspect Element', or you can use a shortcut - \texttt{CMD + OPTION + I (Chrome and Firefox), this will vary between browsers.
\\
...
\begin{tools}
    ...
    \item The ability to edit your HTML and CSS on the fly, with immediate feedback in the browser
\end{tools}
...
The Network and Audit evaluate your sites performance in terms of: 
